    ...
    <>
      ...
      >
        ...
        <svg
          ...
          aria-hidden="true"
        >
          {/* Phone handset / chat bubble */}
          <path
            fill="#ffffff"
            d="M4.868 43.303l2.694-9.835a18.953 18.953 0 0 1-2.535-9.489C5.031 13.093 13.867 4.257 24.75 4.257c5.279.002 10.233 2.057 13.953 5.783a19.614 19.614 0 0 1 5.774 13.966c-.004 10.883-8.841 19.72-19.727 19.72a19.7 19.7 0 0 1-9.406-2.39L4.868 43.303z"
          />
          <path
            fill="#25D366"
            d="M4.868 43.803a.5.5 0 0 1-.482-.631l2.639-9.636a19.446 19.446 0 0 1-2.596-9.557C4.433 12.816 13.519 3.757 24.75 3.757c5.415.002 10.499 2.111 14.322 5.94a20.11 20.11 0 0 1 5.905 14.309c-.004 11.232-9.09 20.221-20.227 20.221a20.19 20.19 0 0 1-9.632-2.44l-9.874 2.009a.498.498 0 0 1-.376-.093z"
          />
          <path
            fill="#ffffff"
            fillRule="evenodd"
            d="M19.268 16.045c-.355-.79-.729-.806-1.068-.82-.277-.012-.593-.011-.909-.011s-.83.124-1.265.619c-.435.495-1.661 1.622-1.661 3.956 0 2.334 1.7 4.59 1.937 4.906.237.316 3.282 5.259 8.104 7.161 4.007 1.58 4.823 1.266 5.693 1.187.87-.079 2.807-1.147 3.202-2.255.395-1.108.395-2.057.277-2.255-.119-.198-.435-.316-.909-.554s-2.807-1.385-3.242-1.543c-.435-.158-.751-.237-1.068.238-.316.474-1.225 1.543-1.502 1.859-.277.317-.554.357-1.028.119-.474-.237-2.002-.738-3.815-2.354-1.41-1.257-2.362-2.81-2.639-3.285-.277-.474-.03-.731.208-.968.213-.213.474-.554.712-.831.237-.277.316-.475.474-.791.158-.317.079-.594-.04-.831-.118-.238-1.035-2.584-1.461-3.493z"
          />
        </svg>
