...
export const createPayment = async (req, res) => {
  try {
    ...
    /**
     * CASE: Already pending + link already exists
     * Reuse existing link to avoid duplicate billing
     */
    if (
      status === "pending" &&
    ...
    const payload = {
      ...
      currency_code: "INR",
      payment_amount: paymentAmount,   // ✔ MUST be string w/ 2 decimals
